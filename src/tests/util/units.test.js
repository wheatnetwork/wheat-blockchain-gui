...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of wheat', () => {
      const result = units.getUnit('wheat');
    ...
    it('gets unit of wheat using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of wheat', () => {
      const result = units.getDisplay('wheat');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('wheat', 9);

      const result = units.getUnit('wheat');

      expect(result).toEqual(9);

      units.setUnit('wheat', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('wheat', {
        format: '{amount} TWHEAT',
        fractionDigits: 0,
      });
