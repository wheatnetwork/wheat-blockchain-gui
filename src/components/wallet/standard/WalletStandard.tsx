...
import { /* mojo_to_wheat_string, */ wheat_to_mojo } from '../../../util/wheat';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_wheat_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of wheat in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Wheat that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Wheat that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send wheat to coloured address. Please enter a wheat
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'wheat_addr://') {
    ...
    const amountValue = Number.parseFloat(wheat_to_mojo(amount));
    const feeValue = Number.parseFloat(wheat_to_mojo(fee));
