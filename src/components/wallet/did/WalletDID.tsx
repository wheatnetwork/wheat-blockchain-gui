...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@wheat/core';
import {
...
import { mojo_to_wheat_string } from '../../../util/wheat';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_wheat_string(props.balance)} TWHEAT
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'wheat_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'wheat_addr://') {
