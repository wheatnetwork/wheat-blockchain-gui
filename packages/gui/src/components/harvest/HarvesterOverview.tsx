import { NewFarmingInfo } from '@wheat-network/api';
import { useGetBlockchainStateQuery, useGetHarvestersQuery, useGetNewFarmingInfoQuery } from '@wheat-network/api-react';
import { Flex, FormatBytes, FormatLargeNumber, CardSimple, useCurrencyCode } from '@wheat-network/core';
...
export default function HarvesterOverview() {
  ...
  const isTestnet = (useCurrencyCode() ?? 'WHEAT').toUpperCase() === 'TWHEAT';
