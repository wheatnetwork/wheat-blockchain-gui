import { Flex, MenuItem, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@wheat-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      <Grid item>
        <Flex flexDirection="column" gap={1}>
          ...
          <SettingsText>
            <Trans>
              WalletConnect enables a decentralized app on the Wheat blockchain to communicate and make requests directly
              to a Wheat wallet.
            </Trans>
          </SettingsText>
        </Flex>
                ...
                <Grid item container style={{ width: '400px' }} gap={2}>
                  <SettingsText>
                    <Trans>
                      ...
                      command issued by the Dapp will require confirmation in the Wheat wallet.
                    </Trans>
                  </SettingsText>
                </Grid>
              </>
