import { useGetKeyringStatusQuery, useSetKeyringPassphraseMutation } from '@wheat-network/api-react';
import {
  AlertDialog,
  Button,
  Color,
          ...
          <DialogContent>
            ...
            {!!canSavePassphrase && (
              <Box display="flex" alignItems="center">
                ...
                />
                <Tooltip
                  title={t`Your passphrase can be stored in your system's secure credential store. Wheat will be able to access your keys without prompting for your passphrase.`}
                >
