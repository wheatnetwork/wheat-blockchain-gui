...
import icon from '../../assets/img/wheat_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} Wheat Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/WheatNetwork/wheat-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
