import { Button, CardHero } from '@wheat-network/core';
import { Pooling } from '@wheat-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>Smooth out your WHEAT farming rewards by joining a pool.</Trans>
          </Typography>
