...
import { Flex, UnitFormat, More, Table, mojoToWheatLocaleString, Suspender } from '@wheat/core';
...
import { WalletStatus } from '@wheat/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToWheatLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
