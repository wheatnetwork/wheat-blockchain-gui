import { Button, CardStep, Select, Flex, Link, Loading } from '@wheat-network/core';
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent WHEAT farming rewards. The average returns are the same, but it is much less
            volatile.
          </Trans>
        }
      />
    ...
    >
      ...
      {!loading && hasNFTs && (
        <>
          <Typography variant="subtitle1">
            ...
            &nbsp;
            <Link target="_blank" href="https://docs.wheatcoin.top/pool-farming">
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent WHEAT farming rewards. Create a plot NFT and assign your new plots to a
              group.
            </Trans>
          </Typography>
