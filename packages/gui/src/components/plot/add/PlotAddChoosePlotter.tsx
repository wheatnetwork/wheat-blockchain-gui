import { defaultPlotter, PlotterName } from '@wheat-network/api';
import type { Plotter, PlotterMap } from '@wheat-network/api';
import { useGetPlottersQuery } from '@wheat-network/api-react';
import { CardStep, Select, StateColor } from '@wheat-network/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default Wheat Proof of Space plotter. If unsure, use the default Wheat Proof of Space plotter.
        </Trans>
      </Typography>
