...
import { CardStep, Select, StateColor } from '@wheat/core';
import { useGetPlottersQuery } from '@wheat/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@wheat/api';
import type { Plotter, PlotterMap } from '@wheat/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort wheatpos to the top of the list
    displayablePlotters.sort((a, b) => a == PlotterName.WHEATPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Wheat Proof of Space plotter. If unsure,
            use the default Wheat Proof of Space plotter.
        </Trans>
      </Typography>
