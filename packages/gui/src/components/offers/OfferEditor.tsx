...
import { useCreateOfferForIdsMutation } from '@wheat/api-react';
...
import { wheatToMojo, catToMojo } from '@wheat/core';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  async function onSubmit(formData: FormData) {
    ...
    let feeInMojos = wheatToMojo(formData.fee ?? 0);
