...
import { OfferTradeRecord, toBech32m } from '@wheat/api';
import {
  Button,
  Checkbox,
  Dialog,
...
const testnetDummyHost = 'offers-api-sim.wheat.top';
...
async function postToOfferBin(
  ...
  if (testnet) {
    return 'https://www.wheat.top/offers';
  }
...
enum HashgreenErrorCodes {
  ...
  MARKET_NOT_FOUND = 50029, // Pairing doesn't exist e.g. WHEAT/RandoCoin
...
const KeybaseTeamName = 'wheat_offers';
...
function OfferShareKeybaseDialog(props: OfferShareServiceDialogProps) {
  ...
  const teamName = testnet ? 'testwheatoffersdev' : KeybaseTeamName;
