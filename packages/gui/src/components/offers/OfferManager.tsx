...
import { Offers } from '@wheat/icons';
import {
...
function ConfirmOfferCancellation(props: ConfirmOfferCancellationProps) {
  ...
  async function handleConfirm() {
    const { fee: wheatFee } = methods.getValues();

    const fee = cancelWithTransaction ? wheatToMojo(wheatFee) : new BigNumber(0);
        ...
        <Grid container>
          <Grid xs={12} md={6} lg={5} item>
            <CardHero>
              ...
              <Typography variant="body1">
                <Trans>
                  Create an offer to exchange assets including WHEAT, tokens, and
