...
import { Wallet, WalletType, type CATToken } from '@wheat/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@wheat/api-react';
import { Trans } from '@lingui/macro';
import { FormControl, InputLabel, MenuItem } from '@mui/material';
import { Select, useCurrencyCode } from '@wheat/core';
