...
import { useCreateOfferForIdsMutation, useGetWalletBalanceQuery } from '@wheat-network/api-react';
import {
  Amount,
  AmountProps,
  Back,
...
/*       An NFT offer consists of a single NFT being offered for WHEAT/CAT      */
/* ========================================================================== */
          ...
          <Box style={{ position: 'relative', top: '20px' }}>
            <TooltipIcon>
              <Trans>
                ...
                recommended minimum fee is 0.000005 WHEAT (5,000,000 mojos)
              </Trans>
            </TooltipIcon>
          </Box>
        </Flex>
    ...
    if (
      ...
      switch (tokenWalletInfo.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToWheatLocaleString(walletBalance.spendableBalance, locale);
          balance = mojoToWheat(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*           Currently only supports a single NFT <--> WHEAT/CAT offer          */
/* ========================================================================== */
...
function buildOfferRequest(params: NFTBuildOfferRequestParams) {
  ...
  const baseMojoAmount: BigNumber =
    tokenWalletInfo.walletType === WalletType.CAT ? catToMojo(tokenAmount) : wheatToMojo(tokenAmount);
