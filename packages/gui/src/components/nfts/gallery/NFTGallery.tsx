...
import { Flex, LayoutDashboardSub, Loading, /*useTrans,*/ usePersistState } from '@wheat/core';
// import { defineMessage } from '@lingui/macro';
import { WalletReceiveAddressField } from '@wheat/wallets';
import type { NFTInfo, Wallet } from '@wheat/api';
import { useGetNFTWallets } from '@wheat/api-react';
