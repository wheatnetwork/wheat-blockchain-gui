import type { PlotNFT, PlotNFTExternal } from '@wheat-network/api';
import { useGetPoolLoginLinkQuery } from '@wheat-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@wheat-network/core';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/Wheat-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
