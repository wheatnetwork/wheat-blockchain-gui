import type { UnconfirmedPlotNFT } from '@wheat-network/api';
import { useGetTransactionQuery } from '@wheat-network/api-react';
import { Flex, Link, Loading } from '@wheat-network/core';
