import { useGetKeysQuery, useGetLoggedInFingerprintQuery, usePrefs } from '@wheat-network/api-react';
import {
  ButtonLoading,
  DialogActions,
  Flex,
...
import HeroImage from './images/walletConnectToWheat.svg';
...
export default function WalletConnectAddConnectionDialog(props: WalletConnectAddConnectionDialogProps) {
  ...
  const mainnet = useCurrencyCode() === 'WHEAT';
