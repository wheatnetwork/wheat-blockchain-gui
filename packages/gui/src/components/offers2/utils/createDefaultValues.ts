...
type CreateDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (WHEAT), indicates whether a token or CAT has a default entry
 ...
 * for creating an WHEAT offer, a CAT offer, or an NFT offer. WHEAT and CAT offers will have a default entry in
...
export default function createDefaultValues(params: CreateDefaultValuesParams | undefined = {}): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      nfts,
      wheat: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
