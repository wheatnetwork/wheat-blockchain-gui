...
import { useGetOfferSummaryMutation, useCheckOfferValidityMutation } from '@wheat-network/api-react';
import { isValidURL } from '@wheat-network/core';
...
const log = debug('wheat-gui:OfferProvider');
