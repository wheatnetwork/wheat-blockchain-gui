import { useGetOfferSummaryMutation } from '@wheat-network/api-react';
import { Color, Dropzone, Flex, useSerializedNavigationState, useShowError } from '@wheat-network/core';
