...
import { useGetWalletsQuery } from '@wheat-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@wheat-network/core';
import { Tokens } from '@wheat-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Wheat Asset Tokens (CATs) are tokens built on top of WHEAT</Trans>}
