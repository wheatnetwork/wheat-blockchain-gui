...
import { Flex, Link, StateIndicator, State, Tooltip, useCurrencyCode } from '@wheat-network/core';
      ...
      <Box>
        ...
        <p>
          ...
          <StyledTableForTooltip>
            ...
            <tr>
              <Link target="_blank" href="https://docs.wheatcoin.top/faq/#why-does-my-wheat-farm-say-missing-signage-points">
