...
import WalletConnectProvider, { WalletConnectWheatProjectId } from '../walletConnect/WalletConnectProvider';
                      ...
                      <Suspense fallback={<LayoutLoading />}>
                        <OffersProvider>
                          <NotificationsProvider>
                            <WalletConnectProvider projectId={WalletConnectWheatProjectId}>
