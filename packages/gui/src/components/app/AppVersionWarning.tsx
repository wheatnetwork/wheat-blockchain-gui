import { Button, Flex } from '@wheat-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Wheat application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Wheat services version: {backV}
                <br />
                Wheat application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Wheat application and stop all Wheat services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
