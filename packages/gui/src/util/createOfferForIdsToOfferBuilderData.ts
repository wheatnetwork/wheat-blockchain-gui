import { toBech32m, WalletType } from '@wheat-network/api';
import { mojoToWheat, mojoToCAT } from '@wheat-network/core';
      ...
      if (asset) {
        switch (asset.walletType) {
          case WalletType.STANDARD_WALLET:
            section.wheat.push({ amount: mojoToWheat(numericValue.abs()).toFixed() });
            break;
          case WalletType.CAT:
