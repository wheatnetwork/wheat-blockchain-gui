import type { OfferSummaryRecord, Wallet } from '@wheat-network/api';
import { useTakeOfferMutation } from '@wheat-network/api-react';
import { AlertDialog, wheatToMojo, useOpenDialog, useShowError } from '@wheat-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? wheatToMojo(fee) : new BigNumber(0);
