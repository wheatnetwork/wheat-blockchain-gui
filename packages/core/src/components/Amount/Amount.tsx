...
import wheatToMojo from '../../utils/wheatToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isWheatCurrency = ['WHEAT', 'TWHEAT'].includes(currencyCode);
  const mojo = isWheatCurrency ? wheatToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isWheatCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
