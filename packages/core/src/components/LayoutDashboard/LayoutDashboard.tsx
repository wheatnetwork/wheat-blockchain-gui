import { useGetLoggedInFingerprintQuery, useGetKeyQuery, useFingerprintSettings } from '@wheat-network/api-react';
import { Exit as ExitIcon } from '@wheat-network/icons';
