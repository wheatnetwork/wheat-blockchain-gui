...
import { useSetCATNameMutation } from '@wheat/api-react';
...
import { Tooltip, CardListItem, Flex, Link, useShowError } from '@wheat/core';
...
export default function WalletTokenCard(props: WalletTokenCardProps) {
  ...
  const currentName = walletType === WalletType.STANDARD_WALLET ? 'Wheat' : name;
