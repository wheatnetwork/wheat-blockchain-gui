import { useGenerateMnemonicMutation, useAddPrivateKeyMutation } from '@wheat-network/api-react';
import { ButtonLoading, Form, TextField, Flex, Loading, Logo, useAuth, useShowError } from '@wheat-network/core';
