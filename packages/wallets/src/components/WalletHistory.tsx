import { WalletType, TransactionType, toBech32m } from '@wheat-network/api';
    ...
    field: (row: Row, metadata) => {
      ...
      return (
        <>
          ...
          &nbsp;
          <strong>
            <FormatLargeNumber value={type === WalletType.CAT ? mojoToCAT(row.amount) : mojoToWheat(row.amount)} />
          </strong>
          &nbsp;
          {metadata.unit}
        </>
