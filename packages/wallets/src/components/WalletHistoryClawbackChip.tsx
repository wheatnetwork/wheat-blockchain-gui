import { TransactionType } from '@wheat-network/api';
import type { Transaction } from '@wheat-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@wheat-network/api-react';
import { useTrans, Button } from '@wheat-network/core';
