import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@wheat-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@wheat-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for WHEAT, CATs, or
