...
import { AlertDialog, Card, Flex, wheatToMojo, mojoToWheatLocaleString } from '@wheat/core';
import {
  send_transaction,
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojoToWheatLocaleString(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const SendCard = (props) => {
  ...
  function send() {
    ...
    const fee = wheatToMojo(fee_input.value);
