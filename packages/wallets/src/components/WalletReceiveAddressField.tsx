import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@wheat-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@wheat-network/core';
import { Reload } from '@wheat-network/icons';
