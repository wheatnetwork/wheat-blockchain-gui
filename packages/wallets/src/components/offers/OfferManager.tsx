...
import { OfferTradeRecord } from '@wheat/api';
import fs from 'fs';
...
import { Trade as TradeIcon } from '@wheat/icons';
import { useCancelOfferMutation, useGetOfferDataMutation, useGetWalletsQuery } from '@wheat/api-react';
...
function ConfirmOfferCancellation(props: ConfirmOfferCancellationProps) {
  ...
  async function handleConfirm() {
    ...
    if (cancelWithTransaction) {
      fee = Number.parseFloat(wheatToMojo(xchFee));
    }
      ...
      <Grid container>
        <Grid xs={12} md={6} lg={5} item>
          <CardHero>
            ...
            <Typography variant="body1">
              <Trans>
                Create an offer to exchange WHEAT or other tokens. View an offer to inspect and accept an offer made by another party.
              </Trans>
            </Typography>
