import { SyncingStatus, toBech32m, WalletType } from '@wheat-network/api';
import { useSpendCATMutation, useFarmBlockMutation } from '@wheat-network/api-react';
import {
  AdvancedOptions,
  Button,
  EstimatedFee,
...
export default function WalletCATSend(props: Props) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    const feeValue = wheatToMojo(fee);
