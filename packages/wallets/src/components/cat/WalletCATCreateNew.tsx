...
import { wheatToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@wheat/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = wheatToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Wheat Asset Token Wallet</Trans>
        </Back>
        <Card>
